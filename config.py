...
PLANKTON_COLORS = [
    (80, 200, 120), (60, 210, 180), (160, 220, 80), (100, 180, 220),
    (200, 160, 80), (180, 90, 180), (60, 190, 140), (220, 200, 60),
]
...
RED_SEAWEED_COLOR, RED_SEAWEED_HIGHLIGHT, RED_SEAWEED_WIDTH = (140, 40, 40), (200, 80, 80), 8
...
TUBE_SPONGE_HIGHLIGHT, TUBE_SPONGE_DEPTH_MIN, TUBE_SPONGE_DEPTH_MAX = (220, 200, 160), 0.30, 0.80
...
FAN_CORAL_COLOR, FAN_CORAL_HIGHLIGHT, FAN_CORAL_WIDTH = (200, 100, 150), (255, 150, 200), 2
...
ANEMONE_GLOW_COLOR, ANEMONE_HIGHLIGHT, ANEMONE_WIDTH = (150, 100, 255), (180, 130, 255), 3
...
ROOT_BASE_COLOR, ROOT_ACTIVE_COLOR, ROOT_TIP_COLOR = (130, 100, 80), (210, 170, 110), (255, 220, 150)

# Plant lifecycle
SEED_GROWTH_ENERGY, MATURE_ENERGY_THRESHOLD = 1.0, 3.5
PLANT_BASE_MAINTENANCE, PLANT_SIZE_MAINTENANCE_FACTOR = 0.12, 0.35
PLANT_MAX_AGE = 70.0
SEED_PRODUCTION_ENERGY, SEED_PRODUCTION_COST = 5.5, 2.0
FLOWERING_ENERGY_THRESHOLD, FLOWERING_DURATION = 6.0, 14.0
DECOMPOSITION_NUTRIENT_RETURN, DECOMPOSITION_DURATION = 0.8, 8.0
PLANT_HARD_CAP, SEED_HARD_CAP = 60, 60

# Plankton spawning from plants
PLANKTON_PER_PLANT_CHANCE = 0.012
PLANKTON_HARD_CAP = 200
...
FISH_STATE_ORDER = [FishState.RESTING, FishState.HUNTING, FishState.FLEEING, FishState.MATING, FishState.NESTING]
...
SEED_ENERGY_THRESHOLD, FLOWERING_BASE_CHANCE = 0.6, 0.015
AUTUMN_SEED_BASE_PROBABILITY, SUMMER_SEED_BASE_PROBABILITY, SEED_ENERGY_COST = 0.004, 0.001, 2.0
...
MATING_HEART_SPAWN_INTERVAL, MATING_HEART_RANDOM_RANGE, MATING_GLOW_DECAY_RATE = 1.2, 0.6, 3.0
...
BIOLUM_COLORS = {"common": (180, 230, 255), "cleaner": (100, 255, 220), "predator": (255, 120, 120)}
...
WINTER_SURVIVAL_CHANCE = {
    "kelp": 0.30, "seagrass": 0.55, "algae": 0.15, "red_seaweed": 0.25,
    "lily_pad": 0.80, "tube_sponge": 0.60, "fan_coral": 0.40, "anemone": 0.70,
}
...
_SEASON_PHOTO_MOD = {0: 0.8, 1: 1.2, 2: 0.9, 3: 0.2}  # Photosynthesis modifiers by season
...
PLANT_COVER_STRENGTH = {
    "kelp": 1.4, "seagrass": 1.1, "algae": 0.9, "red_seaweed": 1.2,
    "lily_pad": 1.6, "tube_sponge": 1.3, "fan_coral": 1.5, "anemone": 1.7,
}
