...
class FishEgg:
    def __init__(self, x, y, traits, parent1=None, parent2=None, is_cleaner=False, is_predator=False, brain=None):
        self.x, self.y = x, y
        self.traits = traits
    ...
    def draw(self, screen, camera):
        ...
        if self.is_predator: base_color, glow_color = (255, 80, 80), (255, 160, 160)
        elif self.is_cleaner: base_color, glow_color = (100, 200, 255), (180, 230, 255)
        else: base_color, glow_color = (255, 210, 80), (255, 240, 160)
