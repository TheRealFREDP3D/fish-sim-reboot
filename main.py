...
class Simulation:
    ...
    def draw(self):
        ...
        self.fish_system.draw(
            self.screen, self.camera, self.time, self.dt,
    ...
    def _draw_hud(self):
        ...
        pygame.draw.rect(panel_surf, (*season_color, 80),  (0, 0, panel_w, panel_h), border_radius=8)
        pygame.draw.rect(panel_surf, (*season_color, 160), (0, 0, panel_w, panel_h), border_radius=8, width=1)
        ...
        bar_w  = panel_w - 20
        bar_h  = 6
        pygame.draw.rect(self.screen, (40, 40, 40), (bar_x, bar_y, bar_w, bar_h), border_radius=3)
        fill_w = int(bar_w * ts.season_progress)
        if fill_w > 0:
            pygame.draw.rect(self.screen, season_color, (bar_x, bar_y, fill_w, bar_h), border_radius=3)
        ...
        if ll > 0.02:
            ...
            pygame.draw.circle(self.screen, glow_col, (arc_cx, arc_cy), int(arc_r * ll + 4))
            pygame.draw.circle(self.screen, (255, 255, 200), (arc_cx, arc_cy), max(2, int(arc_r * 0.4 * ll + 2)))
        else:
